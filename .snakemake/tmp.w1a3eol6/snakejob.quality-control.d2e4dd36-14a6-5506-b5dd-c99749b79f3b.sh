...
--wait-for-files /scratch/myousif9/snakemake_hippocampal_unfolding/.snakemake/tmp.w1a3eol6 /home/myousif9/scratch/hcp_unfolding3_jdkrek/601127/hemi-L/coords-IO.nii.gz --latency-wait 5 \
 --attempt 1  \
--wrapper-prefix https://github.com/snakemake/snakemake-wrappers/raw/ \
   --allowed-rules gif_hippo --nocolor --notemp --no-hooks --nolock \
--mode 2  --use-singularity  --singularity-prefix /project/ctb-akhanf/akhanf/singularity/snakemake_containers  --singularity-args "\-e" --use-envmodules --default-resources "mem_mb=4000"  && touch /scratch/myousif9/snakemake_hippocampal_unfolding/.snakemake/tmp.w1a3eol6/d2e4dd36-14a6-5506-b5dd-c99749b79f3b.jobfinished || (touch /scratch/myousif9/snakemake_hippocampal_unfolding/.snakemake/tmp.w1a3eol6/d2e4dd36-14a6-5506-b5dd-c99749b79f3b.jobfailed; exit 1)
